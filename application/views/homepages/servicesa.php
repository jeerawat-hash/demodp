        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-com">แผนกคอมพิวเตอร์</li>
              <li data-filter=".filter-lat">แผนกเย็บหนัง</li>
              <li data-filter=".filter-ec">แผนกอิเล็กทรอนิกส์</li>
            </ul>
          </div>
        </div>
