      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="section-title" data-aos="fade-up">
                <img src="https://demo.jantra.co/AssetsHome/img/servicec.png" width="40%" alt="" class="img-fluid">
          <h2>บริการ กายบำบัด ศูนย์บริการคนพิการจังหวัดสมุทรปราการ</h2>
          <p>บริการ การฟื้นฟูสมรรถนะทางด้านร่างกายให้กับผู้รับการฝึกอาชีพทุกวัน และบริการกายภาพบำบัดให้กับประชาชนทั่วไปในชุมชน ได้แก่ คนพิการ ผู้สูงอายุ และผู้ดูแลคนพิการ</p>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-com">ตัวอย่าง1</li>
              <li data-filter=".filter-lat">ตัวอย่าง2</li>
              <li data-filter=".filter-ec">ตัวอย่าง3</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-com">
            <img src="https://demo.jantra.co/AssetsHome/img/servicecom1.png" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-lat">
            <img src="https://demo.jantra.co/AssetsHome/img/servicelat1.png" class="img-fluid" alt="">
            <div class="portfolio-info">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-ec">
            <img src="https://demo.jantra.co/AssetsHome/img/serviceec1.png" class="img-fluid" alt="">
            <div class="portfolio-info">
