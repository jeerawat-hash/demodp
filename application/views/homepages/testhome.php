                    ...
                    <!--Begin Video Section -->
                        <div class="container" id="video">
                            ...
                            <div class="row" style="margin-left:15px;margin-right:15px;">
                                ...
                                <div id="rypp-demo-1" class="RYPP r16-9" data-playlist="PL2591DC20C4BB4D78" data-rypp="d1d75757"  data-aos="fade-up">
    ...
    <div class="container margin-bottom-20">
        ...
        <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="8">
                        <div class="owl-clients-v1">
                                    <a href="http://www.m-society.go.th/main.php?filename=index" target="_blank">
                                      <img src="https://demo.jantra.co/AssetsHome/img/clients/client-4.png" alt="หน่วยงานที่เกี่ยวข้องกันพก." longdesc="https://demo.jantra.co/AssetsHome/img/clients/client-4.png"></a>
                                    <a href="http://www.dop.go.th/th" target="_blank">
                                      <img src="https://demo.jantra.co/AssetsHome/img/clients/client-4.png" alt="หน่วยงานที่เกี่ยวข้องกันพก." longdesc="https://demo.jantra.co/AssetsHome/img/clients/client-8.png"></a>
                                      <a href="http://www.dop.go.th/th" target="_blank">
                                      <img src="https://demo.jantra.co/AssetsHome/img/clients/client-4.png" alt="หน่วยงานที่เกี่ยวข้องกันพก." longdesc="https://demo.jantra.co/AssetsHome/img/clients/client-4.png"></a>
                                     <a href="http://www.dop.go.th/th" target="_blank">
                                      <img src="https://demo.jantra.co/AssetsHome/img/clients/client-4.png" alt="หน่วยงานที่เกี่ยวข้องกันพก." longdesc="https://demo.jantra.co/AssetsHome/img/clients/client-4.png"></a>
...
@media (min-width: 992px) {
  ...
  .header-fixed .header.header-fixed-shrink .nav > li > .search {
    ...
    .header-fixed .header.header-fixed-shrink i.style-switcher-btn {
     margin-top:-45px;
    }

    .header-fixed .header.header-fixed-shrink .style-switcher{
       margin-top:60px;
    }
  ...
  .header-fixed .header.header-fixed-shrink .navbar-nav .dropdown-menu {
    margin-top: -30px;
  }

    .header-fixed .header.header-fixed-shrink .navbar-nav .dropdown-menu .dropdown-submenu > ul{
    margin-top: -5px;
  }
...
.search-block-v2{
  background-image:url("../../img/patterns/breadcrumbs.html"); 
}
